"""
Generate accurate school analysis report V2
Fixes:
1. Moderated vs External (not school assessment)
2. MXP averages and percentages
3. Top performers: ATAR + Scaled + Rank (no HSC marks)
4. Multi-year trends included
"""
import sqlite3
from pathlib import Path
from datetime import datetime
from analyze_accurate_v2 import analyze_school
...
if __name__ == "__main__":
    print("Generating accurate report V2...")
    ...
    # Generate report
    output_path = BASE_DIR / "abbotsleigh_2024_accurate_v2.md"
